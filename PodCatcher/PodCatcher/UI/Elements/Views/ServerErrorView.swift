...
class ServerView: UIView {
    ...
    private var infoLabel: UILabel = {
        var label = UILabel.setupInfoLabel(infoText: "Having trouble connecting to iTunes server.")
    ...
    private var musicIcon: UIImageView = {
        ...
        musicIcon.image = #imageLiteral(resourceName: "sad-face").withRenderingMode(.alwaysTemplate)
        musicIcon.alpha = 1
        return musicIcon
    }()
