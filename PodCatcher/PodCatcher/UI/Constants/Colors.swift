...
enum Style {
    ...
    enum Font {
        ...
        enum Search {
            static let searchBarTextFieldFont = UIFont(name: "AvenirNext-Regular", size: 16)
        }
    ...
    enum Attributes {
        enum Search {
            static let searchFieldBarButtonItem = [
...
//    enum Font {
//
//        static let main = UIFont.systemFont(ofSize: 16.0)
//
//        enum PlaylistCell {
//            static let title = UIFont.systemFont(ofSize: 14)
//            static let items = UIFont.systemFont(ofSize: 12, weight: .ultraLight)
//
//        }
//
//        enum MiniPlayer {
...
//
//        enum Home {
//            static let buttonItemFont = UIFont.systemFont(ofSize: 16, weight: .regular)
//        }
//
//        enum Search {
//            static let searchBarTextFieldFont = UIFont.systemFont(ofSize: 16, weight: .regular)
//        }
//    }
//
//    enum Attributes {
